...
real*8, allocatable :: delta(:,:),deltas(:,:),deltas12(:,:),deltasxy(:,:)
real*8 :: trmDeltaS,trpDeltaS,trmDeltaS12,trpDeltaS12,trmDeltaSXY,trpDeltaSXY
...
allocate(deltas(nbasis,nbasis))
allocate(deltas12(nbasis,nbasis))
allocate(deltasxy(nbasis,nbasis))
...
tempM = matmul(delta,s12)

deltas12 = matmul(s12,tempM)

tempM = 0.0d0

tempM = matmul(sx,delta)

deltasxy = matmul(tempM,sy)

do i=1,nbasis
if (deltas(i,i) .lt. 0.0d0) then
 trmDeltaS = trmDeltaS + deltas(i,i)
else
 trpDeltaS = trpDeltaS + deltas(i,i)
endif
if (deltas12(i,i) .lt. 0.0d0) then
 trmDeltaS12 = trmDeltaS12 + deltas12(i,i)
else
 trpDeltaS12 = trpDeltaS12 + deltas12(i,i)
endif
if (deltasxy(i,i) .lt. 0.0d0) then
 trmDeltaSXY = trmDeltaSXY + deltasxy(i,i)
else
 trpDeltaSXY = trpDeltaSXY + deltasxy(i,i)
endif
enddo
...
write(6,*)
write(6,'(a30,f10.4)') 'Sum of (-) DeltaS entries', trmDeltaS
write(6,*)
write(6,'(a30,f10.4)') 'Sum of (+) DeltaS entries', trpDeltaS
write(6,*)
...
write(6,*)
write(6,'(a30,f10.4)') 'Sum of (-) S12DeltaS12 entries', trmDeltaS12
write(6,*)
write(6,'(a30,f10.4)') 'Sum of (+) S12DeltaS12 entries', trpDeltaS12
write(6,*)
...
write(6,*)
write(6,'(a30,f10.4)') 'Sum of (-) SxyDeltaSxy entries', trmDeltaSXY
write(6,*)
write(6,'(a30,f10.4)') 'Sum of (+) SxyDeltaSxy entries', trpDeltaSXY
write(6,*)
...
deallocate(delta,deltas,deltas12,deltasxy)
